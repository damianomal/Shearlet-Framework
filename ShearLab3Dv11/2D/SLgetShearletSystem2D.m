...
%See also: SLgetShearletIdxs2D,SLsheardec2D,SLshearrec2D,SLgetSubsystem2D
    ...
    if nargin < 8
        ...
        % default for denoising
        quadratureMirrorFilter = [0.0104933261758410,-0.0263483047033631,-0.0517766952966370,...
                                  0.276348304703363,0.582566738241592,0.276348304703363,...
                                  -0.0517766952966369,-0.0263483047033631,0.0104933261758408]; 
                              
        % mallat esteso, mio
%         quadratureMirrorFilter = [0.01, 0.115, 0.375, 0.375, 0.115, 0.01];
        
        % mallat originale (1992)
%         quadratureMirrorFilter = [0.125, 0.375, 0.375, 0.125];  

        % fancy mallat
         quadratureMirrorFilter = [0.01, 0.105, 0.385, 0.385, 0.105, 0.01]; 
         
%         quadratureMirrorFilter = [0.0041 0.0279 0.1019 0.2221 0.2880 0.2221 0.1019 0.0279 0.0041];         
%         quadratureMirrorFilter = [0.0279 0.1019 0.2221 0.2880 0.2221 0.1019 0.0279];         
         
%          quadratureMirrorFilter = [0.01, 0.125, 0.375, 0.375, 0.125, 0.01]; 

%          quadratureMirrorFilter = [0.01, 0.115, 0.375, 0.375, 0.115, 0.01];
         
         
%          quadratureMirrorFilter = (1./sum(quadratureMirrorFilter,2))*quadratureMirrorFilter;
%          
         if nargin < 7     
    ...
    global gl_shearlets_2d
    
    gl_shearlets_2d = shearlets;
